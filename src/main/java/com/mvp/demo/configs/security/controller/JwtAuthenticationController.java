package com.mvp.demo.configs.security.controller;
...
import com.mvp.demo.configs.security.model.JwtRequest;
import com.mvp.demo.configs.security.output.JwtOutput;
...
public class JwtAuthenticationController {
	...
	public ResponseEntity<?> createAuthenticationToken(@RequestBody JwtRequest authenticationRequest) throws Exception {
		...
		final UserDetails userDetails = userDetailsService
				.loadUserByUsername(authenticationRequest.getEmail(), authenticationRequest.getSenha());
		String token = jwtTokenUtil.createToken(userDetails);
		return ResponseEntity.ok(new JwtOutput(token));
	}
